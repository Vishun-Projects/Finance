          ...
          {loading ? (
            ...
            <>
              ...
              <div className="space-y-3 xl:hidden px-4 pb-4">
                {filteredUsers.map(user => (
                  <div key={user.id} className="rounded-lg border border-border/60 bg-card p-4 shadow-sm space-y-3">
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Docs: {user.documentsCount} • Txns: {user.transactionsCount}
                      </p>
                    ...
                    <div className="flex flex-wrap gap-2 text-xs">
                      ...
                      <Button
                        size="sm"
                        variant={user.status === 'FROZEN' ? 'secondary' : 'outline'}
