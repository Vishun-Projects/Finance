...
const MASTER_BRANDS: Record<string, { category: string; logo: string; keywords: string[] }> = {
  'swiggy': { category: 'Food Outside', logo: 'swiggy', keywords: ['swiggy', 'bundl technologies'] },
  'zomato': { category: 'Food Outside', logo: 'zomato', keywords: ['zomato'] },
  'amazon': { category: 'Clothes / Personal', logo: 'amazon', keywords: ['amazon', 'amzn'] },
  'flipkart': { category: 'Clothes / Personal', logo: 'flipkart', keywords: ['flipkart'] },
  'jio': { category: 'Mobile + Internet', logo: 'jio', keywords: ['jio', 'reliance jio', 'rjio'] },
  'airtel': { category: 'Mobile + Internet', logo: 'airtel', keywords: ['airtel', 'bharti airtel'] },
  'vi': { category: 'Mobile + Internet', logo: 'vi', keywords: ['vi ', 'vodafone', 'idea'] },
  'uber': { category: 'Train Pass', logo: 'uber', keywords: ['uber'] },
  'ola': { category: 'Train Pass', logo: 'ola', keywords: ['ola', 'ani technologies'] },
  'blinkit': { category: 'Groceries + Home', logo: 'blinkit', keywords: ['blinkit', 'grofers'] },
  'zepto': { category: 'Groceries + Home', logo: 'zepto', keywords: ['zepto'] },
  'bigbasket': { category: 'Groceries + Home', logo: 'bigbasket', keywords: ['bigbasket', 'innovative retail'] },
  'netflix': { category: 'OTT + Subscriptions', logo: 'netflix', keywords: ['netflix'] },
  'spotify': { category: 'OTT + Subscriptions', logo: 'spotify', keywords: ['spotify'] },
  'hotstar': { category: 'OTT + Subscriptions', logo: 'hotstar', keywords: ['hotstar', 'disney'] },
  'starbucks': { category: 'Food Outside', logo: 'starbucks', keywords: ['starbucks', 'tata starbucks'] },
  'mcdonalds': { category: 'Food Outside', logo: 'mcdonalds', keywords: ['mcdonalds', 'hardcastle'] },
  'kfc': { category: 'Food Outside', logo: 'kfc', keywords: ['kfc', 'yum brands', 'sapphire foods', 'devyani'] },
  'dominos': { category: 'Food Outside', logo: 'dominos', keywords: ['domino', 'jubilant food'] },
  'nykaa': { category: 'Clothes / Personal', logo: 'nykaa', keywords: ['nykaa', 'fsn e-commerce'] },
  'meesho': { category: 'Clothes / Personal', logo: 'meesho', keywords: ['meesho'] },
  'myntra': { category: 'Clothes / Personal', logo: 'myntra', keywords: ['myntra'] },
  'ajio': { category: 'Clothes / Personal', logo: 'ajio', keywords: ['ajio', 'reliance retail'] },
  'dmart': { category: 'Groceries + Home', logo: 'dmart', keywords: ['dmart', 'avenue supermarts'] },
  'reliance fresh': { category: 'Groceries + Home', logo: 'reliance', keywords: ['reliance fresh', 'reliance retail'] },
  'tata sky': { category: 'Mobile + Internet', logo: 'tata', keywords: ['tata sky', 'tata play'] },
  'tata power': { category: 'Electricity / Water', logo: 'tata', keywords: ['tata power'] },
  'indane': { category: 'Electricity / Water', logo: 'gas', keywords: ['indane', 'indian oil', ' ioc'] },
  'bharat gas': { category: 'Electricity / Water', logo: 'gas', keywords: ['bharat gas', ' bpcl'] },
  'hp gas': { category: 'Electricity / Water', logo: 'gas', keywords: ['hp gas', ' hpcl'] },
  'bescom': { category: 'Electricity / Water', logo: 'electricity', keywords: ['bescom'] },
  'mseb': { category: 'Electricity / Water', logo: 'mseb', keywords: ['mseb', 'mahadiscom'] },
  'adani': { category: 'Electricity / Water', logo: 'adani', keywords: ['adani electricity', 'adani power'] },
  'lic': { category: 'Term Life Insurance', logo: 'lic', keywords: ['lic', 'life insurance corp'] },
  'hdfc life': { category: 'Term Life Insurance', logo: 'hdfc', keywords: ['hdfc life', 'hdfc standard'] },
  'sbi card': { category: 'EMI', logo: 'sbi', keywords: ['sbi card', 'sbicard'] },
  'bajaj finserv': { category: 'EMI', logo: 'bajaj', keywords: ['bajaj finserv', 'bajaj finance'] },
  'zerodha': { category: 'Direct Stocks', logo: 'zerodha', keywords: ['zerodha'] },
  'groww': { category: 'Direct Stocks', logo: 'groww', keywords: ['groww', 'nextbillion'] },
  'upstox': { category: 'Direct Stocks', logo: 'upstox', keywords: ['upstox', 'rksv'] },
  'bookmyshow': { category: 'Entertainment / Outings', logo: 'bookmyshow', keywords: ['bookmyshow', 'bigtree'] },
  'pvr': { category: 'Entertainment / Outings', logo: 'pvr', keywords: ['pvr'] },
  'inox': { category: 'Entertainment / Outings', logo: 'inox', keywords: ['inox'] },
  'makemytrip': { category: 'Train Pass', logo: 'mmt', keywords: ['makemytrip', 'mmt'] },
  'irctc': { category: 'Train Pass', logo: 'irctc', keywords: ['irctc'] },
  'phonepe': { category: 'Fees & Charges', logo: 'phonepe', keywords: ['phonepe'] },
  'paytm': { category: 'Fees & Charges', logo: 'paytm', keywords: ['paytm', 'one97'] },
  'gpay': { category: 'Fees & Charges', logo: 'gpay', keywords: ['gpay', 'google pay'] },
  'cred': { category: 'EMI', logo: 'cred', keywords: ['cred', 'dreamplug', 'dreamplug technologies'] },
  'tata neu': { category: 'Clothes / Personal', logo: 'tata', keywords: ['tata neu', 'tata digital'] },
  'star health': { category: 'Own Health Insurance', logo: 'star-health', keywords: ['star health'] },
  'hdfc ergo': { category: 'Own Health Insurance', logo: 'hdfc', keywords: ['hdfc ergo'] },
  'cleartrip': { category: 'Train Pass', logo: 'cleartrip', keywords: ['cleartrip'] },
  'indianoil': { category: 'Electricity / Water', logo: 'indianoil', keywords: ['indianoil', 'iocl'] },
  'fastag': { category: 'Train Pass', logo: 'fastag', keywords: ['fastag', 'park+', 'netc'] },
  'dunzo': { category: 'Groceries + Home', logo: 'dunzo', keywords: ['dunzo'] },
  'swiggy genie': { category: 'Groceries + Home', logo: 'swiggy', keywords: ['swiggy genie'] },
  '7 eleven': { category: 'Food Outside', logo: 'store', keywords: ['7 eleven', '7eleven', '7-eleven'] },
  'amazon pay': { category: 'Fees & Charges', logo: 'amazon', keywords: ['amazon pay'] },
  'lic india': { category: 'Term Life Insurance', logo: 'lic', keywords: ['lic india', 'lic of india'] },
};
