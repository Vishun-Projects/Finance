  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <div className="lg:hidden sticky top-[calc(4rem+env(safe-area-inset-top))] z-30 bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-lg font-bold ${(selectedTransaction.type === 'credit' || selectedTransaction.type === 'income' || selectedTransaction.amount > 0)
