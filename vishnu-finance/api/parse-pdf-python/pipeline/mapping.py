...
class MapperShim:
    ...
    ROLE_KEYWORDS = {
        ...
        "DEBIT": ["DEBIT", "DEBITS", "DR", "WITHDRAWAL", "WITHDRAWALS", "WITHDRAWAL(DR)", "DEBIT AMOUNT", "PAYMENT"],
        "CREDIT": ["CREDIT", "CREDITS", "CR", "DEPOSIT", "DEPOSITS", "DEPOSIT(CR)", "CREDIT AMOUNT", "RECEIPT"],
