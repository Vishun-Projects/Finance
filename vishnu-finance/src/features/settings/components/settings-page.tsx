          ...
          <div className="space-y-3">
            {filteredDocuments.map(doc => {
              ...
              return (
                ...
                <Card key={doc.id} className="card-base transition-colors hover:bg-surface">
...
function CategoryManagement() {
  ...
  return (
    <>
      <Card className="card-base">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="flex size-10 items-center justify-center rounded-md bg-surface">
                <Tag className="size-5 text-[var(--purple)]" />
              </div>
              <div>
            ...
            <Button onClick={() => openCategoryForm()} size="sm">
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            <div className="mb-4 flex items-center gap-2">
              ...
              <SectionLabel className="mb-0 text-sm normal-case tracking-normal text-foreground">
                Income Categories
              </SectionLabel>
              <Chip variant="neutral">{incomeCategories.length}</Chip>
            </div>
            {loading && incomeCategories.length === 0 ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                {incomeCategories.map((category) => (
                  <div key={category.id} className="flex items-center justify-between rounded-md border border-border bg-surface p-3 transition-colors hover:bg-background">
                    <div className="flex flex-1 items-center gap-2">
                      ...
                      {category.isDefault && <Chip variant="neutral">Default</Chip>}
                    </div>
                    {!category.isDefault && (
                      <div className="flex gap-1">
                        <Button variant="ghost" size="icon" className="size-8" onClick={() => openCategoryForm(category)}>
          ...
          <div>
            <div className="mb-4 flex items-center gap-2">
              ...
              <Chip variant="neutral">{expenseCategories.length}</Chip>
            </div>
      ...
      {showForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[var(--overlay)] backdrop-blur-sm" onClick={() => { setShowForm(false); setEditingCategory(null); }}>
          <Card className="card-base mx-4 w-full max-w-md" onClick={(e) => e.stopPropagation()}>
            <CardHeader>
              <div className="flex items-center justify-between">
    ...
    <>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full space-y-8">
          ...
          <TabsList className="hidden h-auto w-full min-w-0 items-center justify-start gap-1 overflow-x-auto rounded-md border border-border bg-surface p-1 md:flex">
            {[
              ...
              <TabsTrigger
                key={tab.value}
                value={tab.value}
                className="flex items-center gap-2 rounded-[var(--radius-sm)] px-4 py-2 text-xs font-medium text-muted transition-all data-[state=active]:bg-background data-[state=active]:text-foreground"
              >
            ...
            <div className="space-y-4">
              ...
              <Card className="card-base">
                <CardHeader>
                  <div className="flex items-center gap-3">
                    <div className="flex size-10 items-center justify-center rounded-md bg-surface">
                      <span className="text-lg font-medium text-success">₹</span>
                    </div>
                    <div>
          ...
          <TabsContent value="notifications" className="space-y-6">
            <Card className="card-base overflow-hidden">
              <div className="divide-y divide-border">
                <div className="flex items-center justify-between p-6 transition-colors hover:bg-surface">
                  <div className="flex items-center gap-4">
                    <div className="flex size-12 items-center justify-center rounded-md border border-[var(--orange-border)] bg-[var(--orange-bg)]">
                      <Mail className="size-6 text-[var(--orange)]" />
                    </div>
                    <div>
                ...
                <div className="flex items-center justify-between p-6 transition-colors hover:bg-surface">
                  <div className="flex items-center gap-4">
                    <div className="flex size-12 items-center justify-center rounded-md border border-[var(--purple-border)] bg-[var(--purple-bg)]">
                      <Smartphone className="size-6 text-[var(--purple)]" />
                    </div>
                    <div>
                ...
                <div className="flex items-center justify-between p-6 transition-colors hover:bg-surface">
                  <div className="flex items-center gap-4">
                    <div className="flex size-12 items-center justify-center rounded-md border border-[var(--info-border)] bg-[var(--info-bg)]">
                ...
                <div className="flex items-center justify-between p-6 transition-colors hover:bg-surface">
                  <div className="flex items-center gap-4">
                    <div className="flex size-12 items-center justify-center rounded-md border border-[var(--warning-border)] bg-[var(--warning-bg)]">
              ...
              {(preferences.emailEnabled || preferences.telegramEnabled) && (
                <div className="space-y-4 border-t border-border bg-surface p-6">
                  ...
                  {preferences.telegramEnabled && (
                    <div className="space-y-2">
                      <SectionLabel>Telegram Chat ID</SectionLabel>
                      <Input
            ...
            <div className="flex items-center justify-between pt-2">
              <p className="text-[11px] font-medium uppercase tracking-wide text-hint">
          ...
          <TabsContent value="security" className="space-y-6">
            ...
            {/* Danger Zone */}
            <Card className="card-base border-[var(--danger-border)] bg-[var(--danger-bg)]">
              <CardHeader>
                <div className="flex items-center gap-3">
                  <div className="flex size-10 items-center justify-center rounded-md bg-[var(--danger-bg)]">
