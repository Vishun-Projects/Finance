...
import { Tag, ProsCons, icons } from '@/features/money-plan/components/money-plan-inline-ui';
...
export function InvestmentsTab() {
  ...
  return (
    <div className="space-y-3">
      <PlanCallout variant="blue" title="CA Rule — SIP Kabhi Band Mat Karna" icon={planIcons.info}>
      ...
      <PlanCallout variant="red" title="Avoid — CA Warning" icon={icons.x}>
